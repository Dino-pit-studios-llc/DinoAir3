...
security_issues = [
    {
        ...
        "## References\n"
        "* Python: [Assignment "
        "statements](http://docs.python.org/2/reference/simple_stmts.html#assignment-statements).\n"
    ...
    },
    {
        ...
        "## References\n"
        "* Python: [Assignment "
        "statements](http://docs.python.org/reference/simple_stmts.html#assignment-statements), "
        "[The import "
        "statement](http://docs.python.org/reference/simple_stmts.html#the-import-statement).\n"
        "* Python Tutorial: [Importing \\* from a "
        "package](http://docs.python.org/2/tutorial/modules.html#importing-from-a-package).\n"
        "* Common Weakness Enumeration: "
        "[CWE-563](https://cwe.mitre.org/data/definitions/563.html).\n",
    },
    {
