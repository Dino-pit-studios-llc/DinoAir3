...
class SecretManager:
    ...
    def get_secret(self, key: str, default: str | None = None) -> str | None:
        ...
        if self.provider == "environment":
            return SecretManager._get_from_environment(key, default)
    ...
    @staticmethod
    def _get_from_environment(key: str, default: str | None = None) -> str | None:
    ...
    def _get_from_azure_kv(self, key: str, default: str | None = None) -> str | None:
        ...
        try:
            ...
            warnings.warn(
                f"Failed to get secret from Azure Key Vault: {e}",
                RuntimeWarning,
                stacklevel=2,
            )
            return SecretManager._get_from_environment(key, default)
    ...
    @staticmethod
    def _get_from_aws_secrets(key: str, default: str | None = None) -> str | None:
        ...
        try:
            ...
            warnings.warn(
                f"Failed to get secret from AWS Secrets Manager: {e}",
                RuntimeWarning,
                stacklevel=2,
            )
            return SecretManager._get_from_environment(key, default)
