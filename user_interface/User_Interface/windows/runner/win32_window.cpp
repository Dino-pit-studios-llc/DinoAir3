...
constexpr std::array<const wchar_t, 28> kWindowClassName =
...
constexpr std::array<const wchar_t, 62> kGetPreferredBrightnessRegKey =
    L"Software\\Microsoft\\Windows\\CurrentVersion\\Themes\\Personalize";
constexpr std::array<const wchar_t, 18> kGetPreferredBrightnessRegValue =
    L"AppsUseLightTheme";

// Helper function to encapsulate active window count instead of a global.
...
const wchar_t *WindowClassRegistrar::GetWindowClass() {
  if (!class_registered_) {
    ...
    if (atom == 0) {
      OutputDebugString(
          L"RegisterClass failed in WindowClassRegistrar::GetWindowClass\n");
      return nullptr;
    }
...
Win32Window::Win32Window() { ++ActiveWindowCount(); }
...
return HandleDestroy(hwnd);
                            LPARAM const lparam) noexcept {
                              ...
                              case WM_DPICHANGED: {
                                ...
                                SetWindowPos(hwnd, nullptr, newRectSize->left,
                                             newRectSize->top, newWidth,
                                             newHeight,
                              ...
                              case WM_SIZE: {
                                ...
                                if (child_content_ != nullptr) {
                                  ...
                                  MoveWindow(child_content_, rect.left,
                              ...
                              return DefWindowProc(window_handle_, message,
                                                   wparam, lparam);
                            }
                            ...
                            void
                            Win32Window::SetQuitOnClose(bool quit_on_close) {
                            ...
                            void Win32Window::UpdateTheme(HWND const window) {
                              ...
                              if (result == ERROR_SUCCESS) {
                                ...
                                DwmSetWindowAttribute(
                                    window, DWMWA_USE_IMMERSIVE_DARK_MODE,
                                    &enable_dark_mode,
