...
# Type alias for common mapping type
...
def _copy_known_fields(raw: StrAnyMapping) -> dict[str, Any]:
    """
...
def _apply_default_version(norm: dict[str, Any], model_fields: StrAnyMapping) -> None:
    """
