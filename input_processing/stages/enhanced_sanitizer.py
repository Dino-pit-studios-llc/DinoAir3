...
class EnhancedInputSanitizer:
    ...
    @staticmethod
    def _sanitize_context_filename(sanitized: str, strict_mode: bool) -> str:
        return EnhancedInputSanitizer._sanitize_filename(sanitized)

    @staticmethod
    def _sanitize_context_url(sanitized: str, strict_mode: bool) -> str:
        return EnhancedInputSanitizer._sanitize_url(sanitized)

    @staticmethod
    def _sanitize_context_json(sanitized: str, strict_mode: bool) -> str:
        return EnhancedInputSanitizer._sanitize_json(sanitized)

    def _sanitize_context_general(self, sanitized: str, strict_mode: bool) -> str:
        # General context - apply all protections
        if EnhancedInputSanitizer._detect_path_traversal(sanitized):
            self.security_monitor.log_attack_attempt("Path Traversal", sanitized)
            sanitized = EnhancedInputSanitizer._sanitize_path_traversal(sanitized)
        if EnhancedInputSanitizer._detect_command_injection(sanitized):
            self.security_monitor.log_attack_attempt("Command Injection", sanitized)
            sanitized = EnhancedInputSanitizer._sanitize_command_injection(sanitized)
        if self.xss_protection.detect_xss_attempt(sanitized):
            self.security_monitor.log_attack_attempt("XSS", sanitized)
            sanitized = self.xss_protection.strip_tags(sanitized)
    ...
    @staticmethod
    def _sanitize_json(value: str) -> str:
    ...
    @staticmethod
    def _detect_path_traversal(text: str) -> bool:
    ...
    @staticmethod
    def _sanitize_path_traversal(text: str) -> str:
        """Remove path traversal attempts."""
        import re
    ...
    @staticmethod
    def _detect_command_injection(text: str) -> bool:
    ...
    @staticmethod
    def _sanitize_command_injection(text: str) -> str:
