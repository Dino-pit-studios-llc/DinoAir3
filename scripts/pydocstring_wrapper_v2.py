...
class PydocstringWrapper:
    ...
    def generate_docstring(self, file_path: Path, line_number: int) -> str:
        ...
        try:
            ...
            content = self._extract_docstring_content(result.stdout)
            if not content:
    ...
    def _run_pydocstring(self, file_path: Path, line_number: int) -> subprocess.CompletedProcess:
    ...
    def _extract_docstring_content(self, output: str) -> str:
