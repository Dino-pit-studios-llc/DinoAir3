...
class CircularDependencyDetector:
    ...
    def detect_cycles(self) -> list[list[str]]:
        ...
        return CircularDependencyDetector._deduplicate_cycles(cycles)
    ...
    @staticmethod
    def suggest_fixes(cycles: list[list[str]]) -> dict[str, list[str]]:
...
def main():
    ...
    parser.add_argument(
        "--fix",
        action="store_true",
        help="Suggest fixes for detected circular dependencies",
    )
