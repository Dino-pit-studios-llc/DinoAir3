...
if __name__ == "__main__":
    ...
    with open(output_file, "w", encoding="utf-8") as out_file:
        out_file.write("# GitHub Security Issues - Generated Python List\n")
        out_file.write(f"# Generated on: {datetime.now().isoformat()}\n")
        out_file.write(f"# Total issues: {len(security_issues_list)}\n\n")
        out_file.write("security_issues = ")
