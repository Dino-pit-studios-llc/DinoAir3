...
class TranslatorService:
    ...
    def translate(self, req: TranslateRequest) -> TranslateResponse:
        ...
        try:
            ...
            return TranslatorService._create_error_response(e, target_lang)
        ...
        errors = TranslatorService._normalize_list(result.get("errors", []))
        warnings = TranslatorService._normalize_list(result.get("warnings", []))
        metadata = TranslatorService._extract_metadata(result.get("metadata"))
        ...
        try:
            ...
            return TranslatorService._create_validation_error_response(language, ve)
