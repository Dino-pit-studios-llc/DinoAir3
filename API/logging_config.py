...
class RedactionService:
    ...
    def _replace_auth_pattern(
        ...
        end = RedactionService._find_pattern_end(text, start, terminator)
...
class ISOFormatter(JsonFormatter):
    ...
    def add_fields(
        ...
        ISOFormatter._add_timestamp(log_record)
        ISOFormatter._normalize_level(log_record, record)
        ISOFormatter._add_logger_name(log_record, record)
    ...
    def _copy_structured_fields(
        ...
        with contextlib.suppress(Exception):
            ...
            ISOFormatter._mirror_path_to_route(log_record)
