...
class ErrorHandler:
    ...
    def handle_exception(
        ...
        severity = ErrorHandler._determine_severity(exception)
        ...
        suggestions = ErrorHandler.get_suggestions(exception, category)
    ...
    @staticmethod
    def get_suggestions(exception: Exception, category: ErrorCategory) -> list[str]:
    ...
    def _log_error(self, error_info: ErrorInfo) -> None:
        ...
        formatted_message = ErrorHandler.format_error_message(error_info)
