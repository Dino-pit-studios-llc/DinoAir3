...
class OpenAIModel(BaseTranslationModel):
    ...
    def initialize(self, model_path: Path | None = None, **kwargs) -> None:
        ...
        """
        logger.info("Initializing OpenAI model: %s", self.config["model_name"])
    ...
    def translate(
        ...
        try:
            ...
            code = OpenAIModel._extract_code(generated_text, config.target_language)
    ...
    @staticmethod
    def validate_input(instruction: str) -> tuple[bool, str | None]:
        """
    ...
    @staticmethod
    def _extract_code(response: str, language: OutputLanguage) -> str:
