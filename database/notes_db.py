...
class NotesDatabase:
    ...
    @staticmethod
    def _handle_simple_success(operation_result: OperationResult) -> bool:
    ...
    def get_note(self, note_id: str) -> Note | None:
        ...
        return cast(
            "Note | None",
            NotesDatabase._handle_data_result(self._service.get_note(note_id)),
        )
    ...
    def get_all_tags(self) -> dict[str, int]:
        ...
        return cast(
            "dict[str, int]",
            NotesDatabase._handle_data_result(self._service.get_all_tags(), {}),
        )
