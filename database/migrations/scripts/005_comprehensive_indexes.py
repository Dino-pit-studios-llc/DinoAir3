...
class ComprehensiveIndexMigration(BaseMigration):
    ...
    def up(self, conn: sqlite3.Connection) -> None:
        ...
        try:
            ...
            ComprehensiveIndexMigration._add_single_column_indexes(cursor)

            # Add compound indexes for common query patterns
            ComprehensiveIndexMigration._add_compound_indexes(cursor)

            # Add partial indexes for specific use cases
            ComprehensiveIndexMigration._add_partial_indexes(cursor)

            # Update existing indexes if needed
            ComprehensiveIndexMigration._optimize_existing_indexes(cursor)
