...
class VectorSearchEngine:
    ...
    def _cosine_results(
        ...
        results: list[SearchResult] = [
            VectorSearchEngine._build_search_result(emb_data, score)
    ...
    def _euclidean_results(
        ...
        for emb in all_embeddings:
            ...
            if score >= similarity_threshold:
                results.append(VectorSearchEngine._build_search_result(emb, score))
        return results
    ...
    def keyword_search(
        ...
        try:
            ...
            keywords = VectorSearchEngine._extract_keywords(query)
